...
type Message struct {
	...
	From           string                 `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`                                           // 送信者
	...
	CreatedAt      *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`                //作成日時
}
